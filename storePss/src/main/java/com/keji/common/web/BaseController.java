package com.keji.common.web;


import com.keji.common.Constants;
import com.keji.common.exception.BizException;
import com.keji.common.exception.CustomException;
...
public abstract class BaseController {
    ...
    public String customException(CustomException e) {
        ...
        String json = JsonUtil.getResponseJsonNotEmpty(e.getCode(), e.getMsg(), null);
        System.out.println("错误的json");
        return json;
    }
